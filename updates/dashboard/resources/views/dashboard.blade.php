...
<head>
    ...
    <style>
        ...
        *{box-sizing:border-box}html,body{margin:0;min-height:100%;font-family:Inter,ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;color:var(--text);background:var(--bg)}
        button{font:inherit}.app{min-height:100vh;display:grid;grid-template-columns:302px minmax(0,1fr)}
...
<div class="app">
    <aside class="sidebar">
        ...
        <div class="nav-home"><span class="nav-icon">⌂</span><span>Главная</span></div>
        <div class="nav-group">
            <div class="nav-title"><span class="nav-icon news">▦</span><span>Новости</span><span class="chev">⌃</span></div>
            <div class="nav-sub"><span class="dot"></span><span>Источники Бота</span></div>
            <div class="nav-sub"><span class="dot"></span><span>Настройки Бота</span></div>
        </div>
        <div class="nav-group">
        ...
        <div class="nav-group">
            ...
            <div class="nav-sub"><span class="dot"></span><span>Пользователи</span></div>
        </div>
