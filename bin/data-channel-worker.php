...
$accountsFile = $scope === 'news' ? $storageDir . '/telegram-news-accounts.json' : $storageDir . '/telegram-accounts.json';
$sessionsDir = $scope === 'news' ? $storageDir . '/telegram-news-sessions' : $storageDir . '/telegram-sessions';
