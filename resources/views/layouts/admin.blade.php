...
<div class="sg-app" data-admin-app>
    ...
    <div class="sg-shell">
        <header class="sg-topbar">
            <button class="sg-icon-button sg-mobile-menu-button" type="button" data-sidebar-open aria-label="Открыть меню">
                <span></span><span></span><span></span>
            </button>

            <div class="sg-system-state">
                <span class="sg-state-dot"></span>
                <span>Система работает</span>
            </div>

            <div class="sg-topbar-right">
                <div class="sg-clock" data-kyiv-clock>--:--:--</div>
                ...
                <form method="POST" action="{{ route('admin.logout') }}">
                    @csrf
                    <button class="sg-link-button" type="submit">Выйти</button>
                </form>
            </div>
        </header>
        ...
        <main class="sg-main">
            <div class="sg-page-header">
                ...
                @isset($actions)
                    <div class="sg-page-actions">{{ $actions }}</div>
                @endisset
            </div>
