...
<div class="grid">
<details class="card">
<summary class="accordion-head"><div class="accordion-title"><div class="accordion-copy"><h2>Технічний акаунт</h2><p>Підключення через Telethon</p></div></div><div style="display:flex;align-items:center;gap:12px"><span class="status {{ $settings->technical_status === 'connected' ? 'ok' : 'warn' }}">{{ $settings->technical_status === 'connected' ? 'Підключений' : 'Не підключений' }}</span><span class="accordion-arrow">⌄</span></div></summary>
...
<details class="card">
<summary class="accordion-head"><div class="accordion-title"><div class="accordion-copy"><h2>Telegram API</h2><p>Дані з my.telegram.org для підключення Telethon</p></div></div><div style="display:flex;align-items:center;gap:12px"><span class="status {{ $telegramApiConfigured ? 'ok' : 'warn' }}">{{ $telegramApiConfigured ? 'Підключено' : 'Не налаштовано' }}</span><span class="accordion-arrow">⌄</span></div></summary>
<div class="accordion-body">
...
<details class="card">
<summary class="accordion-head"><div class="accordion-title"><div class="accordion-copy"><h2>Telegram-бот</h2><p>Простий пульт керування</p></div></div><div style="display:flex;align-items:center;gap:12px"><span class="status {{ $settings->bot_status === 'running' ? 'ok' : 'warn' }}">{{ $settings->bot_status === 'running' ? 'Працює' : 'Не налаштований' }}</span><span class="accordion-arrow">⌄</span></div></summary>
<div class="accordion-body">
<form method="POST" action="{{ route('alerts.settings.update') }}">@csrf @method('PUT')
...
<details class="card">
<summary class="accordion-head"><div class="accordion-title"><div class="accordion-copy"><h2>Поточний стан</h2><p>Службова інформація</p></div></div><span class="accordion-arrow">⌄</span></summary>
