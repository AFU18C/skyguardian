        ...
        <section class="content">
            ...
            <div class="panel">
                ...
                <details class="service">
                    <summary><div class="service-main"><div class="service-icon">TG</div><div class="service-name">Telegram API</div></div><div class="state-wrap"><span class="service-state" title="Не подключено"></span><span class="service-chevron">⌄</span></div></summary>
                    <div class="service-body"><strong>Статус:</strong> не подключено. MadelineProto и учётные данные Telegram будут настроены на следующем этапе.</div>
                </details>

                <details class="service">
                    <summary><div class="service-main"><div class="service-icon">NW</div><div class="service-name">Обработчик новостей</div></div><div class="state-wrap"><span class="service-state" title="Не подключено"></span><span class="service-chevron">⌄</span></div></summary>
                    <div class="service-body"><strong>Статус:</strong> ожидает подключения источников. Воркер пока не запускается.</div>
                </details>

                <details class="service">
                    <summary><div class="service-main"><div class="service-icon">AL</div><div class="service-name">Система оповещений</div></div><div class="state-wrap"><span class="service-state" title="Не подключено"></span><span class="service-chevron">⌄</span></div></summary>
                    <div class="service-body"><strong>Статус:</strong> ожидает настройки правил. Воркер оповещений пока не запускается.</div>
                </details>
            </div>
