...
{
    protected $fillable = [
        'technical_account_id', 'publication_bot_id', 'keywords', 'telegram_channels', 'website_sources', 'freshness_hours',
    ...
    {
        return ['keywords' => 'array', 'telegram_channels' => 'array', 'website_sources' => 'array'];
    }
